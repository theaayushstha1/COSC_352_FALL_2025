...
# This script builds and runs the Go application in a Docker container
# Usage: ./run.sh [--output=csv|json]

IMAGE_NAME="baltimore-homicide-go"
CONTAINER_NAME="baltimore-go-run"
OUTPUT_FORMAT=""

echo "=================================================="
echo "Baltimore City Homicide Analysis - Project 6 (Go)"
echo "=================================================="
echo ""
...
if [ -z "$OUTPUT_FORMAT" ]; then
    ...
    docker run --rm --name $CONTAINER_NAME \
        ...
        -w /output \
        $IMAGE_NAME \
        /app/baltimore-analysis -output=$OUTPUT_FORMAT
fi

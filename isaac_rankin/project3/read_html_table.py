...
def save_tables_csv(tables, file_name="table_data.csv"):
...
def main():
    ...
    try:
        ...
        # source_name = source.split("/")[-1] + ".csv"
        source_name = "/app/csv/" + source.split("/")[-1] + ".csv"

        # Save to CSV
        save_tables_csv(tables, source_name)

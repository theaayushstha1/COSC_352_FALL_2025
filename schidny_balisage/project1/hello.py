...
def main(source: str, output_prefix: str = None):
    """Main function to fetch HTML, parse tables, and save to CSV."""

    try:
        html, base = fetch_html(source)
    except Exception as e:
        print(f"Error fetching {source}: {e}")
        return # Exit the function instead of sys.exit(1)
...
# Call the main function directly with your desired URL or filename
# Replace 'YOUR_URL_OR_FILENAME' with the actual source

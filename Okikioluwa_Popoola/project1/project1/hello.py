...
This program reads HTML tables from a webpage and converts them to CSV format.
It processes all tables found in the document.

Usage:
    python read_html_table.py <URL>

Arguments:
    URL: Web URL containing HTML tables

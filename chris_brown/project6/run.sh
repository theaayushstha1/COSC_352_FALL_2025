...
# Baltimore Homicide Analysis Runner (Golang Version)
# This script builds and runs the Go analysis in Docker

IMAGE_NAME="bmore-analysis-go"
CONTAINER_NAME="bmore-analysis-go-run"

echo "=================================="
echo "Baltimore Homicide Analysis (Go)"
echo "=================================="
echo ""
...
if [ -z "$OUTPUT_FORMAT" ]; then
    ...
    docker run --name $CONTAINER_NAME --rm -v "$(pwd):/output" $IMAGE_NAME -output=$OUTPUT_FORMAT

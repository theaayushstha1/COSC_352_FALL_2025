...
1. **Weapon Type Distribution**: Categorizes and counts homicides by weapon (e.g., Shooting, Stabbing)
2. **Top 10 Neighborhoods by Homicide Incidence**: Displays which address blocks had the highest number of cases
